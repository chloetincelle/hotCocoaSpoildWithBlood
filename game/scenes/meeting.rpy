label meeting:
    ...
    nvl_narrator """
    We talked for a bit, about our tastes, the various softs she could make, and then about the event.{w} I explained that I was from Provence, that I had come to this city for work, and that I was eager to meet friends in the local queer scene.
