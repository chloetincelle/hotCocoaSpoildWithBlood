label kinkArrive:
    ...
    nvl_narrator """
    So when she asked me out, when I agreed and we came to be together, her sudden shyness came as a surprise.
    ...
    She wanted to tell me{w}, but she felt too ashamed.
    """
...
# Sprite : Amélie triste, choquée ? Veut pas que Leïla pense ça ?
    ...
    By that time, she had buried her face in her hands, facing away from me.
    
    She looked ready to run away, and so I ceased my questioning, embarrassed, curious, sad and a little vexed that she would not tell me.

    Eventually, she sat up.
    
    I thought she would leave, and I could not understand what I had done wrong; but instead, she went to fetch a slip of paper, and wrote something on it.
    """
    ...
    nvl_narrator """
    That time our friend smoked, seeing how excited she was at the prospect of becoming an ashtray, I paused and gave it an honest thought; I was not a smoker.
    
    Still, I asked her if she knew where the nearest tobacco store was, and she crossed her arms with surprise.
    """

    # SPRITE : Amélie croise les bras, expression surprise.
